...
//
// 与阶段 1c 的 Kotlin 实现（AdbPublicKey/AdbKey）同源，这里用 Node 再实现一份，
// 供内核侧配对/连接使用。格式来源：libcrypto_utils/android_pubkey.cpp（Apache-2.0）。
//
...
module.exports = { generate, loadOrCreate, publicKeyBlob, pubkeyString, signToken, b64uToBig, DIGEST_INFO_SHA1 };
