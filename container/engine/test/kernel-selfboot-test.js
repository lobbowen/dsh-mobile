...
//      **已于 ADR-0005 整体删除**：内核不再随 APK 分发，基线这条路径连同该函数一起消失。
//
...
//  ⑥ 桥契约
// ============================================================================
//  历史：这里曾把"基线包存在性"的断言拆到 test/kernel-baseline-test.js，
//  因为它依赖**构建产物**、而本文件只该验与产物无关的逻辑。ADR-0005 删除了内置基线，
//  于是那个文件连同"产物断言"一起消失 —— 本文件现在是自举链逻辑的唯一归属。
console.log('\n--- ⑥ 桥契约 ---');
